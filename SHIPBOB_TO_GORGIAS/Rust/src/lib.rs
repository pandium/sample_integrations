...
impl Pandium {
    ...
    /// A human-readable rendering of every secret key/value pair.
    pub fn secrets_repr(&self) -> String {
        self.secrets.repr()
    }

    /// A human-readable rendering of every context key/value pair.
    pub fn context_repr(&self) -> String {
        self.context.repr()
    }
}
