import { HubSpotIndustry, CompanySize, } from '../hubspot/models.js';
export var enrichedApOrganizationsToUpdatedHsCompany = function (enrichedApOrganizations, hsCompany) {
    var _a;
    var enrichedOrganization = enrichedApOrganizations.find(function (organization) {
        return (organization === null || organization === void 0 ? void 0 : organization.primary_domain) === hsCompany.properties.domain;
    });
    if (!enrichedOrganization) {
        throw new Error("Apollo.io could not provide Enriched information for the HubSpot company ".concat(hsCompany.id, ": ").concat(hsCompany.properties.name));
    }
    var updatedProperties = {
        apollo_enriched_date: new Date().toISOString(),
    };
    if (enrichedOrganization.estimated_num_employees) {
        updatedProperties.company_size = getHsCompanySize(enrichedOrganization.estimated_num_employees);
    }
    if (((_a = enrichedOrganization.industry) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase()) in
...
var getHsCompanySize = function (apEmployeeEstimate) {
    switch (true) {
...
var apToHsIndustryMapper = {
    ...
    'alternative dispute resolution': HubSpotIndustry.ALTERNATIVE_DISPUTE_RESOLUTION,
    ...
    'business supplies & equipment': HubSpotIndustry.BUSINESS_SUPPLIES_AND_EQUIPMENT,
    ...
    'electrical/electronic manufacturing': HubSpotIndustry.ELECTRICAL_ELECTRONIC_MANUFACTURING,
    ...
    'information technology & services': HubSpotIndustry.INFORMATION_TECHNOLOGY_AND_SERVICES,
    insurance: HubSpotIndustry.INSURANCE,
    'international affairs': HubSpotIndustry.INTERNATIONAL_AFFAIRS,
    'international trade & development': HubSpotIndustry.INTERNATIONAL_TRADE_AND_DEVELOPMENT,
    ...
    'mechanical or industrial engineering': HubSpotIndustry.MECHANICAL_OR_INDUSTRIAL_ENGINEERING,
    ...
    'non-profit organization management': HubSpotIndustry.NON_PROFIT_ORGANIZATION_MANAGEMENT,
    ...
    'professional training & coaching': HubSpotIndustry.PROFESSIONAL_TRAINING_COACHING,
    'program development': HubSpotIndustry.PROGRAM_DEVELOPMENT,
    'public policy': HubSpotIndustry.PUBLIC_POLICY,
    'public relations & communications': HubSpotIndustry.PUBLIC_RELATIONS_AND_COMMUNICATIONS,
    ...
    'recreational facilities & services': HubSpotIndustry.RECREATIONAL_FACILITIES_AND_SERVICES,
    ...
    'transportation/trucking/railroad': HubSpotIndustry.TRANSPORTATION_TRUCKING_RAILROAD,
    utilities: HubSpotIndustry.UTILITIES,
    'venture capital & private equity': HubSpotIndustry.VENTURE_CAPITAL_PRIVATE_EQUITY,
