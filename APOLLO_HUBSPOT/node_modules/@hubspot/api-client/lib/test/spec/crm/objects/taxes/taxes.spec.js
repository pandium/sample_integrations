...
const index_1 = require("../../../../../codegen/crm/objects/taxes/index");
const index_2 = require("../../../../../index");
describe('api client', () => {
    it('is discoverable', () => {
        const client = new index_2.Client().crm.objects.taxes;
