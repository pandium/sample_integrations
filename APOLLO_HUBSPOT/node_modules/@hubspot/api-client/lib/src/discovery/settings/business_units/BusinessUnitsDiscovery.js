...
const rxjsStub_1 = require("../../../../codegen/settings/business_units/rxjsStub");
...
class BusinessUnitsDiscovery {
    constructor(config) {
        ...
        this.businessUnitApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.BusinessUnitApi(configuration));
    }
}
exports.default = BusinessUnitsDiscovery;
//# sourceMappingURL=BusinessUnitsDiscovery.js.map