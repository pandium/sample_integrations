...
class UsersDiscovery {
    constructor(config) {
        ...
        this.rolesApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.RolesApi(configuration));
        this.teamsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.TeamsApi(configuration));
        this.usersApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.UsersApi(configuration));
    }
}
