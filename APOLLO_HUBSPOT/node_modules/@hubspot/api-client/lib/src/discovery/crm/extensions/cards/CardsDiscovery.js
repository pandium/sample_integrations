...
class CardsDiscovery {
    constructor(config) {
        ...
        this.cardsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.CardsApi(configuration));
        this.sampleResponseApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SampleResponseApi(configuration));
    }
}
