...
class AccountingDiscovery {
    constructor(config) {
        ...
        this.invoiceApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.InvoiceApi(configuration));
        this.settingsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SettingsApi(configuration));
        this.syncApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SyncApi(configuration));
        this.userAccountsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.UserAccountsApi(configuration));
    }
}
