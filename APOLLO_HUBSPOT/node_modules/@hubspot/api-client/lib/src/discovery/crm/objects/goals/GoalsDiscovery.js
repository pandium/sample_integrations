...
const configuration_1 = require("../../../../../codegen/crm/objects/goals/configuration");
const index_1 = require("../../../../../codegen/crm/objects/goals/index");
const rxjsStub_1 = require("../../../../../codegen/crm/objects/goals/rxjsStub");
...
class GoalsDiscovery {
    constructor(config) {
        ...
        this.gdprApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.GDPRApi(configuration));
        this.publicObjectApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.PublicObjectApi(configuration));
        this.searchApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SearchApi(configuration));
    }
}
exports.default = GoalsDiscovery;
//# sourceMappingURL=GoalsDiscovery.js.map