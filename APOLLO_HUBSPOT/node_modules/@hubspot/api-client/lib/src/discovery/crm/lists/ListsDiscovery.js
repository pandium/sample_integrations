...
const rxjsStub_1 = require("../../../../codegen/crm/lists/rxjsStub");
...
class ListsDiscovery {
    constructor(config) {
        ...
        this.listsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.ListsApi(configuration));
        this.membershipsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.MembershipsApi(configuration));
    }
}
exports.default = ListsDiscovery;
//# sourceMappingURL=ListsDiscovery.js.map