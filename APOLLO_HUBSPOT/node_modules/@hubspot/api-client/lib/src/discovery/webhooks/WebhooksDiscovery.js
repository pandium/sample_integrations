...
class WebhooksDiscovery {
    constructor(config = {}) {
        ...
        this.settingsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SettingsApi(configuration));
        this.subscriptionsApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.SubscriptionsApi(configuration));
    }
}
