...
exports.GenerateApiResponseProcessor = exports.GenerateApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class GenerateApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    generateToken(identificationTokenGenerationRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (identificationTokenGenerationRequest === null || identificationTokenGenerationRequest === undefined) {
                throw new baseapi_1.RequiredError("GenerateApi", "generateToken", "identificationTokenGenerationRequest");
            }
...
class GenerateApiResponseProcessor {
