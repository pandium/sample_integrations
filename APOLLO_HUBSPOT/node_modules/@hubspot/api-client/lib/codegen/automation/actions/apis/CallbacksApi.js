...
exports.CallbacksApiResponseProcessor = exports.CallbacksApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class CallbacksApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    complete(callbackId, callbackCompletionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (callbackId === null || callbackId === undefined) {
                throw new baseapi_1.RequiredError("CallbacksApi", "complete", "callbackId");
            }
            if (callbackCompletionRequest === null || callbackCompletionRequest === undefined) {
                throw new baseapi_1.RequiredError("CallbacksApi", "complete", "callbackCompletionRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(callbackCompletionRequest, "CallbackCompletionRequest", ""), contentType);
    ...
    completeBatch(batchInputCallbackCompletionBatchRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputCallbackCompletionBatchRequest === null || batchInputCallbackCompletionBatchRequest === undefined) {
                throw new baseapi_1.RequiredError("CallbacksApi", "completeBatch", "batchInputCallbackCompletionBatchRequest");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(batchInputCallbackCompletionBatchRequest, "BatchInputCallbackCompletionBatchRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class CallbacksApiResponseProcessor {
    complete(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=CallbacksApi.js.map