...
class RevisionsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getById(definitionId, revisionId, appId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (definitionId === null || definitionId === undefined) {
                throw new baseapi_1.RequiredError("RevisionsApi", "getById", "definitionId");
            }
            if (revisionId === null || revisionId === undefined) {
                throw new baseapi_1.RequiredError("RevisionsApi", "getById", "revisionId");
            }
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("RevisionsApi", "getById", "appId");
            }
    ...
    getPage(definitionId, appId, limit, after, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (definitionId === null || definitionId === undefined) {
                throw new baseapi_1.RequiredError("RevisionsApi", "getPage", "definitionId");
            }
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("RevisionsApi", "getPage", "appId");
            }
...
class RevisionsApiResponseProcessor {
    getById(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ActionRevision", "");
                return body;
            }
    ...
    getPage(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseActionRevisionForwardPaging", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
