...
export declare class HubSpotFormDefinitionCreateRequestAllOf {
    'formType': HubSpotFormDefinitionCreateRequestAllOfFormTypeEnum;
    'name': string;
    'createdAt': Date;
    'updatedAt': Date;
    'archived': boolean;
...
export type HubSpotFormDefinitionCreateRequestAllOfFormTypeEnum = "hubspot";
