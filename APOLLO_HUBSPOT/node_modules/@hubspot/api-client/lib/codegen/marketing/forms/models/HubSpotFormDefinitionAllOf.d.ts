...
export declare class HubSpotFormDefinitionAllOf {
    'formType': HubSpotFormDefinitionAllOfFormTypeEnum;
    'id': string;
    'name': string;
    'createdAt': Date;
    'updatedAt': Date;
...
export type HubSpotFormDefinitionAllOfFormTypeEnum = "hubspot";
