...
exports.SubscriberStateChangesApiResponseProcessor = exports.SubscriberStateChangesApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SubscriberStateChangesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    doEmailUpsertById(externalEventId, subscriberState, externalAccountId, batchInputMarketingEventEmailSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doEmailUpsertById", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doEmailUpsertById", "subscriberState");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doEmailUpsertById", "externalAccountId");
            }
            if (batchInputMarketingEventEmailSubscriber === null || batchInputMarketingEventEmailSubscriber === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doEmailUpsertById", "batchInputMarketingEventEmailSubscriber");
            }
    ...
    doUpsertById(externalEventId, subscriberState, externalAccountId, batchInputMarketingEventSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doUpsertById", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doUpsertById", "subscriberState");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doUpsertById", "externalAccountId");
            }
            if (batchInputMarketingEventSubscriber === null || batchInputMarketingEventSubscriber === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "doUpsertById", "batchInputMarketingEventSubscriber");
            }
...
exports.SubscriberStateChangesApiRequestFactory = SubscriberStateChangesApiRequestFactory;
class SubscriberStateChangesApiResponseProcessor {
...
exports.SubscriberStateChangesApiResponseProcessor = SubscriberStateChangesApiResponseProcessor;
//# sourceMappingURL=SubscriberStateChangesApi.js.map