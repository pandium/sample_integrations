...
exports.AttendanceSubscriberStateChangesApiResponseProcessor = exports.AttendanceSubscriberStateChangesApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class AttendanceSubscriberStateChangesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    create(externalEventId, subscriberState, batchInputMarketingEventSubscriber, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "create", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "create", "subscriberState");
            }
            if (batchInputMarketingEventSubscriber === null || batchInputMarketingEventSubscriber === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "create", "batchInputMarketingEventSubscriber");
            }
    ...
    createByEmail(externalEventId, subscriberState, batchInputMarketingEventEmailSubscriber, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "createByEmail", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "createByEmail", "subscriberState");
            }
            if (batchInputMarketingEventEmailSubscriber === null || batchInputMarketingEventEmailSubscriber === undefined) {
                throw new baseapi_1.RequiredError("AttendanceSubscriberStateChangesApi", "createByEmail", "batchInputMarketingEventEmailSubscriber");
            }
...
exports.AttendanceSubscriberStateChangesApiRequestFactory = AttendanceSubscriberStateChangesApiRequestFactory;
class AttendanceSubscriberStateChangesApiResponseProcessor {
    create(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.AttendanceSubscriberStateChangesApiResponseProcessor = AttendanceSubscriberStateChangesApiResponseProcessor;
//# sourceMappingURL=AttendanceSubscriberStateChangesApi.js.map