...
export declare class PublicApiRequestFactory extends BaseAPIRequestFactory {
    getById(contentId: string, type?: 'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE', _options?: Configuration): Promise<RequestContext>;
...
export declare class PublicApiResponseProcessor {
    getById(response: ResponseContext): Promise<IndexedData>;
    search(response: ResponseContext): Promise<PublicSearchResults>;
}
