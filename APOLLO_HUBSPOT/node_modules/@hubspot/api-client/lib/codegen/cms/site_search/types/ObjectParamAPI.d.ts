...
export declare class ObjectPublicApi {
    private api;
    ...
    getById(param: PublicApiGetByIdRequest, options?: Configuration): Promise<IndexedData>;
    search(param?: PublicApiSearchRequest, options?: Configuration): Promise<PublicSearchResults>;
}
