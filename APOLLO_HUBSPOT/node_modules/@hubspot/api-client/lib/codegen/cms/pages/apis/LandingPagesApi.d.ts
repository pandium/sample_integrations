...
export declare class LandingPagesApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getFoldersPage(createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, sort?: Array<string>, after?: string, limit?: number, archived?: boolean, property?: string, _options?: Configuration): Promise<RequestContext>;
...
export declare class LandingPagesApiResponseProcessor {
    ...
    archiveFolder(response: ResponseContext): Promise<void>;
    archiveFolders(response: ResponseContext): Promise<void>;
    ...
    createFolder(response: ResponseContext): Promise<ContentFolder>;
    createFolders(response: ResponseContext): Promise<BatchResponseContentFolder | BatchResponseContentFolderWithErrors>;
    ...
    getFolderById(response: ResponseContext): Promise<ContentFolder>;
    getFolderPreviousVersion(response: ResponseContext): Promise<VersionContentFolder>;
    getFolderPreviousVersions(response: ResponseContext): Promise<CollectionResponseWithTotalVersionContentFolder>;
    getFoldersPage(response: ResponseContext): Promise<CollectionResponseWithTotalContentFolderForwardPaging>;
    ...
    readFolders(response: ResponseContext): Promise<BatchResponseContentFolder | BatchResponseContentFolderWithErrors>;
    rerunPreviousABTest(response: ResponseContext): Promise<void>;
    resetDraft(response: ResponseContext): Promise<void>;
    restoreFolderPreviousVersion(response: ResponseContext): Promise<ContentFolder>;
    ...
    updateFolder(response: ResponseContext): Promise<ContentFolder>;
    updateFolders(response: ResponseContext): Promise<BatchResponseContentFolder | BatchResponseContentFolderWithErrors>;
