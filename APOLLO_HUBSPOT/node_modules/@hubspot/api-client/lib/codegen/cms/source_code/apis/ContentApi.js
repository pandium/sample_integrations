...
class ContentApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    createOrUpdate(environment, path, file, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (environment === null || environment === undefined) {
                throw new baseapi_1.RequiredError("ContentApi", "createOrUpdate", "environment");
            }
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("ContentApi", "createOrUpdate", "path");
            }
            const localVarPath = '/cms/v3/source-code/{environment}/content/{path}'
                .replace('{' + 'environment' + '}', encodeURIComponent(String(environment)))
                .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
    ...
    download(environment, path, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (environment === null || environment === undefined) {
                throw new baseapi_1.RequiredError("ContentApi", "download", "environment");
            }
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("ContentApi", "download", "path");
            }
            const localVarPath = '/cms/v3/source-code/{environment}/content/{path}'
                .replace('{' + 'environment' + '}', encodeURIComponent(String(environment)))
                .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
