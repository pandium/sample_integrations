...
exports.ExtractApiResponseProcessor = exports.ExtractApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class ExtractApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    extractByPath(path, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("ExtractApi", "extractByPath", "path");
            }
...
exports.ExtractApiRequestFactory = ExtractApiRequestFactory;
class ExtractApiResponseProcessor {
    extractByPath(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ExtractApiResponseProcessor = ExtractApiResponseProcessor;
//# sourceMappingURL=ExtractApi.js.map