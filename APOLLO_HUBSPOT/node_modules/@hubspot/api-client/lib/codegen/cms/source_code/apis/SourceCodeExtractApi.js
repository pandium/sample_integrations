...
exports.SourceCodeExtractApiResponseProcessor = exports.SourceCodeExtractApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SourceCodeExtractApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    doAsync(fileExtractRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (fileExtractRequest === null || fileExtractRequest === undefined) {
                throw new baseapi_1.RequiredError("SourceCodeExtractApi", "doAsync", "fileExtractRequest");
            }
    ...
    getAsyncStatus(taskId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("SourceCodeExtractApi", "getAsyncStatus", "taskId");
            }
...
exports.SourceCodeExtractApiRequestFactory = SourceCodeExtractApiRequestFactory;
class SourceCodeExtractApiResponseProcessor {
    doAsync(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.SourceCodeExtractApiResponseProcessor = SourceCodeExtractApiResponseProcessor;
//# sourceMappingURL=SourceCodeExtractApi.js.map