...
const BatchInputBlogAuthor_1 = require("../models/BatchInputBlogAuthor");
const BatchInputJsonNode_1 = require("../models/BatchInputJsonNode");
const BatchInputString_1 = require("../models/BatchInputString");
const BatchResponseBlogAuthor_1 = require("../models/BatchResponseBlogAuthor");
const BatchResponseBlogAuthorWithErrors_1 = require("../models/BatchResponseBlogAuthorWithErrors");
const BlogAuthor_1 = require("../models/BlogAuthor");
const BlogAuthorCloneRequestVNext_1 = require("../models/BlogAuthorCloneRequestVNext");
const CollectionResponseWithTotalBlogAuthorForwardPaging_1 = require("../models/CollectionResponseWithTotalBlogAuthorForwardPaging");
...
let typeMap = {
    ...
    "BatchInputBlogAuthor": BatchInputBlogAuthor_1.BatchInputBlogAuthor,
    "BatchInputJsonNode": BatchInputJsonNode_1.BatchInputJsonNode,
    "BatchInputString": BatchInputString_1.BatchInputString,
    "BatchResponseBlogAuthor": BatchResponseBlogAuthor_1.BatchResponseBlogAuthor,
    "BatchResponseBlogAuthorWithErrors": BatchResponseBlogAuthorWithErrors_1.BatchResponseBlogAuthorWithErrors,
    "BlogAuthor": BlogAuthor_1.BlogAuthor,
    "BlogAuthorCloneRequestVNext": BlogAuthorCloneRequestVNext_1.BlogAuthorCloneRequestVNext,
    "CollectionResponseWithTotalBlogAuthorForwardPaging": CollectionResponseWithTotalBlogAuthorForwardPaging_1.CollectionResponseWithTotalBlogAuthorForwardPaging,
