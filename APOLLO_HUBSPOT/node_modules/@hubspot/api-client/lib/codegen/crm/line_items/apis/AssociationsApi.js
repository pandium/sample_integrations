...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(lineItemId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "lineItemId");
            }
    ...
    create(lineItemId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "lineItemId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(lineItemId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "lineItemId");
            }
            if (toObjectType === null || toObjectType === undefined) {
