...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(lineItemId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "lineItemId");
            }
            const localVarPath = '/crm/v3/objects/line_items/{lineItemId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/line_items';
    ...
    getById(lineItemId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "lineItemId");
            }
            const localVarPath = '/crm/v3/objects/line_items/{lineItemId}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)));
    ...
    update(lineItemId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (lineItemId === null || lineItemId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "lineItemId");
            }
