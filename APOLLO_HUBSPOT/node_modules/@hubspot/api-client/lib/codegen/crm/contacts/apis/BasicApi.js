...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(contactId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "contactId");
            }
    ...
    getById(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "contactId");
            }
            const localVarPath = '/crm/v3/objects/contacts/{contactId}'
                .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
    ...
    update(contactId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "contactId");
            }
