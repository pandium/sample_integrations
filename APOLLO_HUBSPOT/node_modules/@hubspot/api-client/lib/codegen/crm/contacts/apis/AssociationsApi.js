...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(contactId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "contactId");
            }
    ...
    create(contactId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "contactId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(contactId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (contactId === null || contactId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "contactId");
            }
            if (toObjectType === null || toObjectType === undefined) {
