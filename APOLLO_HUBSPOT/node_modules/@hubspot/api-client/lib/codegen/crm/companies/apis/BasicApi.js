...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(companyId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (companyId === null || companyId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "companyId");
            }
    ...
    getById(companyId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (companyId === null || companyId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "companyId");
            }
            const localVarPath = '/crm/v3/objects/companies/{companyId}'
                .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)));
    ...
    update(companyId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (companyId === null || companyId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "companyId");
            }
