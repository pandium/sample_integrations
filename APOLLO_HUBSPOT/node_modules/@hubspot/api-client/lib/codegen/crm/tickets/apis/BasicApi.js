...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(ticketId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "ticketId");
            }
            const localVarPath = '/crm/v3/objects/tickets/{ticketId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/tickets';
    ...
    getById(ticketId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "ticketId");
            }
            const localVarPath = '/crm/v3/objects/tickets/{ticketId}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)));
    ...
    update(ticketId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "ticketId");
            }
