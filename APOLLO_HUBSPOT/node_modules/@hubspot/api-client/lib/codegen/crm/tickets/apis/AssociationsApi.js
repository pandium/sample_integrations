...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(ticketId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "ticketId");
            }
            ...
            const localVarPath = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(ticketId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "ticketId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(ticketId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (ticketId === null || ticketId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "ticketId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
