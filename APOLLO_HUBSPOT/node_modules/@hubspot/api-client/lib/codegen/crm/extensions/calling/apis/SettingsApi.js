...
class SettingsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(appId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "archive", "appId");
            }
    ...
    create(appId, settingsRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "create", "appId");
            }
            if (settingsRequest === null || settingsRequest === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "create", "settingsRequest");
            }
            const localVarPath = '/crm/v3/extensions/calling/{appId}/settings'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(settingsRequest, "SettingsRequest", ""), contentType);
    ...
    update(appId, settingsPatchRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "update", "appId");
            }
            if (settingsPatchRequest === null || settingsPatchRequest === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "update", "settingsPatchRequest");
            }
            const localVarPath = '/crm/v3/extensions/calling/{appId}/settings'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(settingsPatchRequest, "SettingsPatchRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["developer_hapikey"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
