...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(productId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "productId");
            }
            ...
            const localVarPath = '/crm/v3/objects/products/{productId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(productId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "productId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(productId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "productId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/products/{productId}/associations/{toObjectType}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
