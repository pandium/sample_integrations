...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(productId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "productId");
            }
            const localVarPath = '/crm/v3/objects/products/{productId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/products';
    ...
    getById(productId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "productId");
            }
            const localVarPath = '/crm/v3/objects/products/{productId}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)));
    ...
    update(productId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (productId === null || productId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "productId");
            }
