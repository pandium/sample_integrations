...
export declare class BasicApiRequestFactory extends BaseAPIRequestFactory {
    archive(quoteId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    update(quoteId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext>;
}
