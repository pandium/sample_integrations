...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(quoteId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "quoteId");
            }
    ...
    getById(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "quoteId");
            }
            const localVarPath = '/crm/v3/objects/quotes/{quoteId}'
                .replace('{' + 'quoteId' + '}', encodeURIComponent(String(quoteId)));
    ...
    update(quoteId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "quoteId");
            }
