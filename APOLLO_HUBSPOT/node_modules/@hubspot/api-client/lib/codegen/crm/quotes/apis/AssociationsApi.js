...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(quoteId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "quoteId");
            }
            ...
            const localVarPath = '/crm/v3/objects/quotes/{quoteId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(quoteId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "quoteId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(quoteId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (quoteId === null || quoteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "quoteId");
            }
            if (toObjectType === null || toObjectType === undefined) {
