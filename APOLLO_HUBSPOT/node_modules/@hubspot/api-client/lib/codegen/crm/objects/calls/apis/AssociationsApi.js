...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(callId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "callId");
            }
            ...
            const localVarPath = '/crm/v3/objects/calls/{callId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(callId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "callId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(callId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "callId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/calls/{callId}/associations/{toObjectType}'
                .replace('{' + 'callId' + '}', encodeURIComponent(String(callId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
