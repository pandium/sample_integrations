...
exports.ObjectSearchApi = exports.ObjectPublicObjectApi = exports.ObjectBatchApi = exports.ObjectBasicApi = void 0;
...
class ObjectBasicApi {
    ...
    archive(param, options) {
        return this.api.archive(param.communicationId, options).toPromise();
    }
    ...
    update(param, options) {
        return this.api.update(param.communicationId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
}
