...
exports.PromiseSearchApi = exports.PromisePublicObjectApi = exports.PromiseBatchApi = exports.PromiseBasicApi = void 0;
...
class PromiseBasicApi {
    ...
    archive(postalMail, _options) {
        const result = this.api.archive(postalMail, _options);
    ...
    getById(postalMail, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getById(postalMail, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    update(postalMail, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.update(postalMail, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
}
...
class PromisePublicObjectApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_3.ObservablePublicObjectApi(configuration, requestFactory, responseProcessor);
    }
