...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectType, objectId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "objectType");
            }
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "objectId");
            }
            ...
            if (associationType === null || associationType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "associationType");
            }
    ...
    create(objectType, objectId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "objectType");
            }
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "objectId");
            }
            if (toObjectType === null || toObjectType === undefined) {
            ...
            if (associationType === null || associationType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "associationType");
            }
            const localVarPath = '/crm/v3/objects/{objectType}/{objectId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)))
    ...
    getAll(objectType, objectId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "objectType");
            }
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "objectId");
            }
            if (toObjectType === null || toObjectType === undefined) {
...
class AssociationsApiResponseProcessor {
    ...
    getAll(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseAssociatedIdForwardPaging", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
