...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(meetingId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "meetingId");
            }
            const localVarPath = '/crm/v3/objects/meetings/{meetingId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/meetings';
    ...
    getById(meetingId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "meetingId");
            }
            const localVarPath = '/crm/v3/objects/meetings/{meetingId}'
                .replace('{' + 'meetingId' + '}', encodeURIComponent(String(meetingId)));
    ...
    update(meetingId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "meetingId");
            }
