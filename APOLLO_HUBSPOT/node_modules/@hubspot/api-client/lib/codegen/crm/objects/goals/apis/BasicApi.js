...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(goalTargetId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (goalTargetId === null || goalTargetId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "goalTargetId");
            }
            const localVarPath = '/crm/v3/objects/goal_targets/{goalTargetId}'
                .replace('{' + 'goalTargetId' + '}', encodeURIComponent(String(goalTargetId)));
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/goal_targets';
    ...
    getById(goalTargetId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (goalTargetId === null || goalTargetId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "goalTargetId");
            }
            const localVarPath = '/crm/v3/objects/goal_targets/{goalTargetId}'
                .replace('{' + 'goalTargetId' + '}', encodeURIComponent(String(goalTargetId)));
    ...
    update(goalTargetId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (goalTargetId === null || goalTargetId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "goalTargetId");
            }
