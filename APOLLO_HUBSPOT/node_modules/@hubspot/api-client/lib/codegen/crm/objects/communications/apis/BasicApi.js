...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(communicationId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (communicationId === null || communicationId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "communicationId");
            }
    ...
    getById(communicationId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (communicationId === null || communicationId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "communicationId");
            }
            const localVarPath = '/crm/v3/objects/Communications/{communicationId}'
                .replace('{' + 'communicationId' + '}', encodeURIComponent(String(communicationId)));
    ...
    update(communicationId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (communicationId === null || communicationId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "communicationId");
            }
