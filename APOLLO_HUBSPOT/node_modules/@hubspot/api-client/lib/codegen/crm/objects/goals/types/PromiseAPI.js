...
exports.PromiseSearchApi = exports.PromisePublicObjectApi = exports.PromiseGDPRApi = exports.PromiseBatchApi = exports.PromiseBasicApi = void 0;
...
class PromiseBasicApi {
    ...
    archive(goalTargetId, _options) {
        const result = this.api.archive(goalTargetId, _options);
    ...
    update(goalTargetId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.update(goalTargetId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
}
