...
exports.ObjectSearchApi = exports.ObjectPublicObjectApi = exports.ObjectGDPRApi = exports.ObjectBatchApi = exports.ObjectBasicApi = void 0;
...
class ObjectBasicApi {
    ...
    archive(param, options) {
        return this.api.archive(param.goalTargetId, options).toPromise();
    }
    ...
    update(param, options) {
        return this.api.update(param.goalTargetId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
}
