...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(taskId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "taskId");
            }
            const localVarPath = '/crm/v3/objects/tasks/{taskId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/tasks';
    ...
    getById(taskId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "taskId");
            }
            const localVarPath = '/crm/v3/objects/tasks/{taskId}'
                .replace('{' + 'taskId' + '}', encodeURIComponent(String(taskId)));
    ...
    update(taskId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "taskId");
            }
