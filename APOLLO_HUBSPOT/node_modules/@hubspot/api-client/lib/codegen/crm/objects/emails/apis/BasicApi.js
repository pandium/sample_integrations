...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(emailId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (emailId === null || emailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "emailId");
            }
            const localVarPath = '/crm/v3/objects/emails/{emailId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/emails';
    ...
    getById(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (emailId === null || emailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "emailId");
            }
            const localVarPath = '/crm/v3/objects/emails/{emailId}'
                .replace('{' + 'emailId' + '}', encodeURIComponent(String(emailId)));
    ...
    update(emailId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (emailId === null || emailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "emailId");
            }
