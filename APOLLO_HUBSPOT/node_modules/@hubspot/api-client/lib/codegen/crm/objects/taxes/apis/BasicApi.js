...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(taxId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taxId === null || taxId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "taxId");
            }
            const localVarPath = '/crm/v3/objects/taxes/{taxId}'
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/taxes';
    ...
    getById(taxId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taxId === null || taxId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "taxId");
            }
            const localVarPath = '/crm/v3/objects/taxes/{taxId}'
                .replace('{' + 'taxId' + '}', encodeURIComponent(String(taxId)));
    ...
    update(taxId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taxId === null || taxId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "taxId");
            }
