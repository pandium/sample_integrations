...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "feedbackSubmissionId");
            }
    ...
    create(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "feedbackSubmissionId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getPage(feedbackSubmissionId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getPage", "feedbackSubmissionId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getPage", "toObjectType");
            }
