...
export declare class PromiseBasicApi {
    ...
    archive(goalTargetId: string, _options?: Configuration): Promise<void>;
    ...
    update(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<SimplePublicObject>;
}
