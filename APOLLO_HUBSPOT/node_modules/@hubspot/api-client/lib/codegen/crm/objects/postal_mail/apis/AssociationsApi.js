...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(postalMail, toObjectType, toObjectId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "postalMail");
            }
            ...
            const localVarPath = '/crm/v4/objects/postal_mail/{postalMail}/associations/{toObjectType}/{toObjectId}'
    ...
    create(postalMail, toObjectType, toObjectId, associationSpec, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "postalMail");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(postalMail, toObjectType, after, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "postalMail");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v4/objects/postal_mail/{postalMail}/associations/{toObjectType}'
                .replace('{' + 'postalMail' + '}', encodeURIComponent(String(postalMail)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
