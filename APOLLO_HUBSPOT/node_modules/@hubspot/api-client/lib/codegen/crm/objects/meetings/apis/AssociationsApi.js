...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(meetingId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "meetingId");
            }
            ...
            const localVarPath = '/crm/v3/objects/meetings/{meetingId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(meetingId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "meetingId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(meetingId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (meetingId === null || meetingId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "meetingId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/meetings/{meetingId}/associations/{toObjectType}'
                .replace('{' + 'meetingId' + '}', encodeURIComponent(String(meetingId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
