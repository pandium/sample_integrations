...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(noteId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (noteId === null || noteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "noteId");
            }
            ...
            const localVarPath = '/crm/v3/objects/notes/{noteId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(noteId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (noteId === null || noteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "noteId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(noteId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (noteId === null || noteId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "noteId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/notes/{noteId}/associations/{toObjectType}'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
