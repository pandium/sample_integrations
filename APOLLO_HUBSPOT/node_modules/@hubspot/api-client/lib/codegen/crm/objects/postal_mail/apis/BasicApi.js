...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(postalMail, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "postalMail");
            }
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (simplePublicObjectInputForCreate === null || simplePublicObjectInputForCreate === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "simplePublicObjectInputForCreate");
            }
            const localVarPath = '/crm/v3/objects/postal_mail';
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(simplePublicObjectInputForCreate, "SimplePublicObjectInputForCreate", ""), contentType);
    ...
    getById(postalMail, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "postalMail");
            }
            const localVarPath = '/crm/v3/objects/postal_mail/{postalMail}'
                .replace('{' + 'postalMail' + '}', encodeURIComponent(String(postalMail)));
    ...
    update(postalMail, simplePublicObjectInput, idProperty, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMail === null || postalMail === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "postalMail");
            }
