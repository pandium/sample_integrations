...
export declare class BasicApiRequestFactory extends BaseAPIRequestFactory {
    archive(feedbackSubmissionId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    update(feedbackSubmissionId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext>;
}
