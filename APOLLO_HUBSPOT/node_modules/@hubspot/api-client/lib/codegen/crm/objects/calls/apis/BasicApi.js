...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(callId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "callId");
            }
    ...
    getById(callId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "callId");
            }
            const localVarPath = '/crm/v3/objects/calls/{callId}'
                .replace('{' + 'callId' + '}', encodeURIComponent(String(callId)));
    ...
    update(callId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (callId === null || callId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "callId");
            }
