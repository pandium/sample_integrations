...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(taskId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "taskId");
            }
            ...
            const localVarPath = '/crm/v3/objects/tasks/{taskId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    create(taskId, toObjectType, toObjectId, associationType, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "taskId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(taskId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "taskId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v3/objects/tasks/{taskId}/associations/{toObjectType}'
                .replace('{' + 'taskId' + '}', encodeURIComponent(String(taskId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
